...
<h1 class="text-3xl font-bold text-gonpay-dark mb-6"><?= $translations['get_started_now'] ?? "Get Started Now" ?></h1>
<p class="text-gray-600 mb-8"><?= $translations['log_in_to_access_your_account_and_manage_your_loya'] ?? "Log in to access your account and manage your loyalty cards" ?></p>
...
<input class="h-4 w-4 text-gonpay-orange border-gray-300 rounded focus:ring-gonpay-orange" id="remember-me" name="remember-me" type="checkbox"/>
<label class="ml-2 block text-sm text-gray-600" for="remember-me"><?= $translations['remember_me'] ?? "Remember Me" ?></label>
</div>
<a class="text-gonpay-orange hover:text-gonpay-orange-dark text-sm font-medium transition-all duration-300" href="forgot_password.php"><?= $translations['forgot_password'] ?? "Forgot Password?" ?></a>
</div>
...
<h2 class="text-4xl font-bold text-white mb-6"><?= $translations['welcome_back'] ?? "Welcome Back!" ?></h2>
<div class="flex items-center">
<div class="mr-4 mt-2">
