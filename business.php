            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-white group hover:bg-gonpay-orange transition-colors duration-300 rounded-3xl overflow-hidden shadow-sm hover:shadow-md flex flex-col"
                    ...
                    <div class="p-8 flex-grow">
                        <div class="flex items-center mb-4">
                            <div
                                class="w-10 h-10 rounded-lg bg-gradient-to-r from-gonpay-orange to-yellow-300 mr-4 flex items-center justify-center">
                    ...
                    <div class="p-8 flex-grow">
                        <div class="flex items-center mb-4">
                            <div class="w-10 h-10 bg-white rounded-lg mr-4 flex items-center justify-center">
                                <svg class="h-6 w-6 text-gonpay-orange" fill="currentColor" viewbox="0 0 24 24">
                                    <path
                                        d="M8 6h8c1.1 0 2 .9 2 2v2c0 .55-.45 1-1 1s-1-.45-1-1V8h-2v10h2v-2c0-.55.45-1 1-1s1 .45 1 1v2c0 1.1-.9 2-2 2H8c-1.1 0-2-.9-2-2V8c0-1.1.9-2 2-2z">
                                    </path>
                                </svg>
                            </div>
                            <div>
                ...
                <div class="bg-white group hover:bg-gonpay-orange transition-colors duration-300 rounded-3xl overflow-hidden shadow-sm hover:shadow-md flex flex-col"
                    ...
                    <div class="p-8 flex-grow">
                        <div class="flex items-center mb-4">
                            <div
                                class="w-10 h-10 rounded-lg bg-gradient-to-r from-orange-400 to-orange-600 mr-4 flex items-center justify-center">
