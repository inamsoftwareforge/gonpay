    ...
    <div class="container mx-auto px-4 py-8">
            ...
            <div class="w-full flex justify-end">
                <div class="flex flex-col items-start space-y-2">
                    <div class="flex items-center space-x-1">
                        <span
                            class="text-gray-800 font-semibold mr-4"><?= $translations['follow_us'] ?? "Follow Us:" ?></span>
                        <div class="flex items-center gap-3">
                            <a class="text-gray-600 hover:text-gonpay-orange transition-colors"
                                href="https://www.facebook.com/gonpay">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a class="text-gray-600 hover:text-gonpay-orange transition-colors"
                                href="https://www.linkedin.com/company/gonpay/">
                                <i class="fab fa-linkedin-in"></i>
                            </a>
                            <a class="text-gray-600 hover:text-gonpay-orange transition-colors"
                                href="https://www.instagram.com/gonpay/">
                                <i class="fab fa-instagram"></i>
                            </a>
                            <a class="text-gray-600 hover:text-gonpay-orange transition-colors"
                                href="https://www.youtube.com/gonpay">
                    ...
                    <div class="flex items-center space-x-1">
                        <span
                            class="text-gray-800 font-semibold mr-4"><?= $translations['contact_us_3'] ?? "Contact us:" ?></span>
                        <div class="flex items-center gap-3">
                            <a class="text-gray-600 hover:text-gonpay-orange transition-colors"
                                href="mailto:info@gonpay.com">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20 justify-items-start md:justify-items-center">
            ...
            <div class="w-full md:w-auto">
                <h3 class="text-gray-800 text-xl font-bold mb-4 text-left">
                    <?= $translations['subscribe_to_our_newsletter'] ?? "Subscribe To Our Newsletter" ?></h3>
            ...
            <div class="w-full md:w-auto">
                <h3 class="text-gray-800 text-xl font-bold mb-4 text-left">
                    <?= $translations['our_links'] ?? "Our Links" ?></h3>
                <ul class="space-y-3 text-left">
                    <li>
                        <a class="text-gray-600 hover:text-gonpay-orange transition-colors"
                            href="/index.php"><?= $translations['explore_loyalty_2'] ?? "Explore loyalty" ?></a>
                    </li>
                    <li>
                        <a class="text-gray-600 hover:text-gonpay-orange transition-colors"
                            href="business.php"><?= $translations['for_business'] ?? "For Business" ?></a>
                    </li>
                    <li>
                        <a class="text-gray-600 hover:text-gonpay-orange transition-colors"
                            href="company.php"><?= $translations['about_us_3'] ?? "About us" ?></a>
                    </li>
                </ul>
            </div>
            <!-- Help Column -->
        ...
        <div class="pt-6 border-t border-gray-200 text-center">
            <p class="text-gray-500">
                <?= $translations['2025_gonpay_all_rights_reserved'] ?? "© 2025 GoNpay. All Rights Reserved" ?></p>
        </div>
    </div>
</footer>
